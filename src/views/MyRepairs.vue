            ...
            <div class="wrapper" ref="wrapper">
              <div class="weui-panel__bd">
                <a v-for="item in items"
                 ...
                 :href="'/repair-detail/' + item.report_id" 
                 :key="item.id">
                  <div class="weui-media-box__hd">
                    <img class="weui-media-box__thumb"
                     :src="(item.device.image_list.length > 0) ? item.device.image_list[0] : defaultImage"
                     alt="" >
                  </div>
                  <div class="weui-media-box__bd">
                    <h4 class="weui-media-box__title">{{ item.device.name }}</h4>
                    <p class="weui-media-box__desc" style="padding:5px 0px;">{{ item.end_time_format }} &nbsp; <span class="device-repair-status"
                       v-bind:class="{
